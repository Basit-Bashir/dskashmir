async function test() {
  const cases = [
    { catalogName: "LAPTOPS", facetValues: ["category:GAMING"] },
    { catalogName: "LAPTOPS", facetValues: ["category:BUSINESS"] },
    { catalogName: "LAPTOPS", facetValues: ["category:CREATOR"] },
    { catalogName: "LAPTOPS", facetValues: ["category:ULTRABOOK"] }
  ];
