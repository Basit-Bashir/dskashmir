...
import { Heart, ShoppingBag, Star, ChevronLeft, Shield, Truck, RotateCcw } from "lucide-react";
  ...
  return (
    <>
      ...
      <main className="pt-20">
        {/* Breadcrumb */}
        <div className="section-pad py-4 border-b border-hp-light">
          <div className="max-content">
            <div className="flex items-center gap-2 text-[11px] text-hp-gray font-light">
              ...
              <span>/</span>
              <span className="text-hp-black">{product.name}</span>
            </div>
          </div>
        </div>
                    ...
                    <tbody>
                      {product.specs.map(({ label, value }) => (
                        <tr key={label} className="border-b border-hp-light last:border-0">
                          <td className="py-3.5 text-sm font-medium text-hp-black w-40 pr-8">{label}</td>
