async function test() {
  const cases = [
    { catalogName: "Laptops", facetValues: [] },
    { catalogName: "Laptops", facetValues: [""] },
    { catalogName: "Laptops", facetValues: ["categoryName:Laptops"] },
    { catalogName: "Laptops", facetValues: ["category:Laptop"] },
    { catalogName: "Laptops", facetValues: ["productLine:HP"] }
  ];
